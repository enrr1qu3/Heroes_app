...
describe('SearchControls', () => {
    ...
    test('should set input value when search params ame is set', () => {
    ...
    test('should change params when input is changed and enter is pressed', () => {
        ...
        fireEvent.keyDown(input, { key: 'Enter', target: { value: 'Superman' } });
    ...
    test('should accordion be close when active-accordion param is set', () => {
        renderWithRouter(['/?name=Batman']);
        const accordion = screen.getByTestId('accordion');
        const accordionItem = accordion.querySelector('div');
