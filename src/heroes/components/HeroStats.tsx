    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            >
                ...
                <p className="text-xs text-muted-foreground">Strength: {summary?.strongestHero.strength ?? 1}/10</p>
            </HeroStatCard>
            ...
            <HeroStatCard
                ...
                icon={<Heart className="h-4 w-4 text-muted-foreground" />}
            >
                <div className="text-lg font-bold">{summary?.smartestHero.strength}</div>
